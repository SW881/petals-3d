...
const TooltipAdvanced = ({
    ...
    return (
        ...
        >
            ...
            {isVisible && text && (
                <div
                    className={`absolute z-[9999] px-2 py-2 text-sm font-medium text-white bg-[#000000]/75 backdrop-blur-2xl rounded-lg shadow-xl whitespace-nowrap pointer-events-none transition-opacity duration-200 ${positionClasses[position]}`}
                    style={{
